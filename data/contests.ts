...
export const contestRules = [
  { title: "التسجيل", text: "التسجيل من واتساب المبيعات. تُفتح بطاقة تأهيل حماية." },
  ...
  { title: "البيع", text: "طلب مستوى حماية لا يُسعَّر علناً — الاعتماد أمني ومبيعات معاً" },
  { title: "الصدق", text: "الموقع إنجليزي وفيه نموذج عرض سعر. لا مسار عربي سري لتأهيل الطلب قبل كشف المواصفة." },
];
