...
const items = [
  { title: "جملة الإغلاق", text: "العميل لا يشتري سيارة. يشتري مستوى حماية. الاقتراح يظهر هنا والإفصاح يبقى بشرياً" },
  { title: "ما يدرَّب عليه المندوب", text: "يعيد الوعد كما هو: طلب مستوى حماية لا يُسعَّر علناً — الاعتماد أمني ومبيعات معاً ثم يحول الرسالة بطاقة." },
