...
export const siteConfig = {
  nameAr: "كبار الشخصيات للتصفيح",
  nameEn: "VIP Armouring",
  brandLine: "VIP",
  productName: "تصور مبيعات تصفيح مركبات مدنية وعسكرية",
  parentAr: "VIP Armouring Industry Company",
  parentEn: "VIP Armouring",
  recipient: "مدير المبيعات",
  recipientRole: "كبار الشخصيات للتصفيح",
  country: "الأردن",
  city: "عمّان",
  cityDetailAr: "مجمّع كادبي الصناعي، الأردن",
  since: 0,
  websiteUrl: "https://viparmouring.com/",
  defaultMapsUrl: "",
  defaultWhatsAppPhone: "962795956954",
  defaultWhatsAppPrefill: "السلام عليكم كبار الشخصيات للتصفيح بخصوص ",
  defaultEmails: ["bassam@vip-armouring.com"] as const,
  phones: ["962795956954", "962778161110"] as const,
  salesPhone: "962795956954",
